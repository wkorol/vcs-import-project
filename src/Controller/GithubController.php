...

{
    ...
    public function fetchData($url): array
    {
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-type: application/json', 'User-Agent: vcs-import-project', 'Authorization: token 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'));
